...
/** 语言选择持久化 key */
export const STORAGE_LANG_KEY = "qcopy_lang";
...
export const uiDictMap: Record<SupportedLang, UiDict> = {
  en: {
    siteTitle: "QCopy — Native macOS File Copy",
    metaDesc: "A native macOS file copy tool. Fast bulk copy without Finder's long prep phase.",
    brand: "QCopy",
